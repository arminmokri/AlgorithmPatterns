...
|----|-----------------------------------------------------------------------|------|--------|----|------------------------------------------------------------------|---------------------------------------|
| 1  | [Set Matrix Zeroes](set_matrix_zeroes/)                               | ✅   | ❌     | ❌ | [LeetCode #73](https://leetcode.com/problems/set-matrix-zeroes)  |                                       |
...
| 5  | [Min Max Row Sum Matrix Partition](min_max_row_sum_matrix_partition/) | ✅   | ✅     | ❌ |                                                                  | [`#Bounteous`](https://bounteous.com) |
| 6  | [Lucy’s Spiral Hop](lucy_spiral_hop/)                                 | ✅   | ✅     | ❌ | [Brainly](https://brainly.com/question/31047283)                 | [`#Cisco`](https://cisco.com)         |
